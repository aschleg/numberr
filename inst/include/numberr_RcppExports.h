...
namespace numberr {
    ...
    inline NumericVector fermat(unsigned int n) {
        ...
        if (p_fermat == NULL) {
            ...
            p_fermat = (Ptr_fermat)R_GetCCallable("numberr", "numberr_fermat");
        }
        RObject rcpp_result_gen;
        {
            RNGScope RCPP_rngScope_gen;
            rcpp_result_gen = p_fermat(Rcpp::wrap(n));
        }
        if (rcpp_result_gen.inherits("interrupted-error"))
            throw Rcpp::internal::InterruptedException();
        if (rcpp_result_gen.inherits("try-error"))
    ...
    inline unsigned long int gcd_division(int a, int b) {
        typedef SEXP(*Ptr_gcd_division)(SEXP,SEXP);
        static Ptr_gcd_division p_gcd_division = NULL;
        if (p_gcd_division == NULL) {
            validateSignature("unsigned long int(*gcd_division)(int,int)");
    ...
    inline bool isprime(unsigned long int n) {
        typedef SEXP(*Ptr_isprime)(SEXP);
        static Ptr_isprime p_isprime = NULL;
        if (p_isprime == NULL) {
            validateSignature("bool(*isprime)(unsigned long int)");
